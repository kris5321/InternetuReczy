import "./chunk-5ZK7OCXL.js";
import {
  Typography_default
} from "./chunk-5IJOWMNP.js";
import {
  Portal,
  useClassNamesOverride,
  useSlotProps
} from "./chunk-PYFBIG55.js";
import {
  useTheme
} from "./chunk-ECNTRJPJ.js";
import {
  require_react_dom
} from "./chunk-TLVXLPKY.js";
import {
  Box_default
} from "./chunk-S5TCYO5Z.js";
import "./chunk-YFAIBU26.js";
import {
  HTMLElementType,
  chainPropTypes,
  exactProp,
...
function useMouseTracker() {
  const svgRef = React30.useContext(SVGContext);
...
function ChartsItemTooltipContent(props) {
  ...
  const series = React32.useContext(SeriesContext)[itemData.type].series[itemData.seriesId];
...
true ? ChartsItemTooltipContent.propTypes = {
  ...
  contentProps: import_prop_types17.default.shape({
    ...
    series: import_prop_types17.default.shape({
      color: import_prop_types17.default.string,
      data: import_prop_types17.default.oneOfType([import_prop_types17.default.arrayOf(import_prop_types17.default.number), import_prop_types17.default.arrayOf(import_prop_types17.default.number), import_prop_types17.default.arrayOf(import_prop_types17.default.shape({
      ...
      })), import_prop_types17.default.arrayOf(import_prop_types17.default.shape({
      ...
      id: import_prop_types17.default.oneOfType([import_prop_types17.default.number, import_prop_types17.default.string]).isRequired,
      type: import_prop_types17.default.oneOf(["bar", "line", "pie", "scatter"]).isRequired,
      valueFormatter: import_prop_types17.default.func.isRequired
    }),
...
function DefaultChartsAxisTooltipContent(props) {
  ...
  return (0, import_jsx_runtime28.jsx)(ChartsTooltipPaper, {
    sx,
    className: classes.root,
    children: (0, import_jsx_runtime29.jsxs)(ChartsTooltipTable, {
      className: classes.table,
      children: [axisValue != null && !axis.hideTooltip && (0, import_jsx_runtime28.jsx)("thead", {
        ...
        children: series.map(({
          ...
          return (0, import_jsx_runtime29.jsxs)(ChartsTooltipRow, {
            className: classes.row,
            children: [(0, import_jsx_runtime28.jsx)(ChartsTooltipCell, {
              className: clsx_default(classes.markCell, classes.cell),
              ...
              className: clsx_default(classes.labelCell, classes.cell),
              children: label ? (0, import_jsx_runtime28.jsx)(Typography_default, {
                children: label
              }) : null
            }), (0, import_jsx_runtime28.jsx)(ChartsTooltipCell, {
              className: clsx_default(classes.valueCell, classes.cell),
...
function ChartsTooltip(props) {
  ...
  return (0, import_jsx_runtime31.jsx)(NoSsr, {
    children: popperOpen && (0, import_jsx_runtime31.jsx)(PopperComponent, _extends({}, popperProps, {
      children: trigger === "item" ? (0, import_jsx_runtime31.jsx)(ChartsItemTooltipContent, {
        ...
        classes
      }) : (0, import_jsx_runtime31.jsx)(ChartsAxisTooltipContent, {
...
function DefaultChartsLegend(props) {
  ...
  return (0, import_jsx_runtime32.jsx)(NoSsr, {
...
function ChartsAxisHighlight(props) {
  ...
  return (0, import_jsx_runtime35.jsxs)(React37.Fragment, {
    children: [xAxisHighlight === "band" && axis.x !== null && isBandScale(xScale) && (0, import_jsx_runtime34.jsx)(ChartsAxisHighlightPath, {
    ...
    }), yAxisHighlight === "band" && axis.y !== null && isBandScale(yScale) && (0, import_jsx_runtime34.jsx)(ChartsAxisHighlightPath, {
...
var _excluded14 = ["x", "y", "id", "classes", "color"];
...
function LineHighlightElement(props) {
  ...
  return (0, import_jsx_runtime37.jsx)(HighlightElement, _extends({}, other, {
    ownerState,
    className: classes.root,
    cx: 0,
    cy: 0,
...
function LineHighlightPlot(props) {
  ...
  const seriesData = React40.useContext(SeriesContext).line;
  ...
  return (0, import_jsx_runtime38.jsx)("g", _extends({}, other, {
    children: stackingGroups.flatMap(({
      ...
      return groupIds.flatMap((seriesId) => {
        ...
        return (0, import_jsx_runtime38.jsx)(Element2, _extends({
          id: seriesId,
          color: series[seriesId].color,
          x: x2,
          y: y2
...
var LineChart = React41.forwardRef(function LineChart2(props, ref) {
  const {
    xAxis,
    yAxis,
    series,
  ...
  return (0, import_jsx_runtime40.jsxs)(ResponsiveChartContainer, {
    ...
    children: [(0, import_jsx_runtime40.jsxs)("g", {
      ...
      children: [(0, import_jsx_runtime39.jsx)(AreaPlot, {
        slots,
        slotProps
      }), (0, import_jsx_runtime39.jsx)(LinePlot, {
        slots,
        slotProps
      })]
    }), (0, import_jsx_runtime39.jsx)(ChartsAxis, {
      topAxis,
      leftAxis,
      rightAxis,
      bottomAxis,
      slots,
      slotProps
    }), (0, import_jsx_runtime39.jsx)(ChartsAxisHighlight, _extends({}, axisHighlight)), (0, import_jsx_runtime39.jsx)(MarkPlot, {
      slots,
      slotProps
    }), (0, import_jsx_runtime39.jsx)(LineHighlightPlot, {
      slots,
      slotProps
    }), (0, import_jsx_runtime39.jsx)(ChartsLegend, _extends({}, legend, {
      slots,
      slotProps
    })), (0, import_jsx_runtime39.jsx)(ChartsTooltip, _extends({}, tooltip, {
      slots,
      slotProps
    })), (0, import_jsx_runtime39.jsx)(ChartsClipPath, {
      id: clipPathId
    }), children]
  });
});
true ? LineChart.propTypes = {
   ...
   */
  disableLineItemHighlight: import_prop_types26.default.bool,
  /**
  ...
  series: import_prop_types26.default.arrayOf(import_prop_types26.default.shape({
    area: import_prop_types26.default.bool,
    color: import_prop_types26.default.string,
    connectNulls: import_prop_types26.default.bool,
    curve: import_prop_types26.default.oneOf(["catmullRom", "linear", "monotoneX", "monotoneY", "natural", "step", "stepAfter", "stepBefore"]),
    data: import_prop_types26.default.arrayOf(import_prop_types26.default.number),
    dataKey: import_prop_types26.default.string,
    disableHighlight: import_prop_types26.default.bool,
    ...
    label: import_prop_types26.default.string,
    showMark: import_prop_types26.default.oneOfType([import_prop_types26.default.func, import_prop_types26.default.bool]),
    stack: import_prop_types26.default.string,
    stackOffset: import_prop_types26.default.oneOf(["diverging", "expand", "none", "silhouette", "wiggle"]),
    stackOrder: import_prop_types26.default.oneOf(["appearance", "ascending", "descending", "insideOut", "none", "reverse"]),
    type: import_prop_types26.default.oneOf(["line"]),
    valueFormatter: import_prop_types26.default.func,
    xAxisKey: import_prop_types26.default.string,
    yAxisKey: import_prop_types26.default.string
  })).isRequired,
  /**
   * The props used for each component slot.
   * @default {}
